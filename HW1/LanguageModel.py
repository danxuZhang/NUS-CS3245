...
class LanguageModel:
    ...
    def __init__(self, name: str, n: int = 4) -> None:
        ...
        Args:
            ...
            n: n-gram model, by default it's a 4-gram model
        """
        self._name = name
    ...
    def add_string(self, text: string) -> None:
...
def test():
    ...
    lm1.add_string("Hello world! 123 hello yes Yes yes.")
    lm2 = LanguageModel("Test2")
    lm2.add_string("Bye bye! No no no.")
    print(lm1._occurs)
